defmodule TallyWeb.UserAuthTest do
  use TallyWeb.ConnCase, async: true

  alias Tally.Accounts
  alias Tally.Accounts.Scope
  alias TallyWeb.UserAuth

  import Tally.AccountsFixtures

  @remember_me_cookie "_tally_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TallyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
